open_delete_property_heir_modal = (property_heir) => {
...
open_update_property_heir_modal = (property_heir) => {
    ...
    document.getElementById('update-title').innerText = `Update Heir Associates: ${property_heir.heir.first_name} ${property_heir.heir.last_name}`
